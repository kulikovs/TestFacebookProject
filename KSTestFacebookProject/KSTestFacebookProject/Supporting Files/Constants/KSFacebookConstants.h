...
static NSString * const kKSPhotoDataKey     = @"photos.data";
static NSString * const kKSAlbumsDataKey    = @"albums.data";
static NSString * const kKSPictureKey       = @"picture";
...
#define kKSUserPhotosRequestParameters      @{@"fields": @"albums{photos{picture}}"}
